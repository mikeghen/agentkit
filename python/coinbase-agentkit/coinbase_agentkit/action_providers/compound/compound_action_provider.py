...
""",
    ...
    def supply(self, wallet_provider: EvmWalletProvider, args: dict[str, Any]) -> str:
        ...
        try:
            ...
            token_address = self._get_asset_address(wallet_provider.get_network(), validated_args.asset_id)
            ...
            if current_health == Decimal("Infinity") and new_health == Decimal("Infinity"):
                ...
                health_message = f"Health ratio changed from {current_health:.2f} to {new_health:.2f}"
...
""",
    ...
    def withdraw(self, wallet_provider: EvmWalletProvider, args: dict[str, Any]) -> str:
        ...
        try:
            ...
            collateral_balance = get_collateral_balance(wallet_provider, comet_address, token_address)
...
""",
    ...
    def borrow(self, wallet_provider: EvmWalletProvider, args: dict[str, Any]) -> str:
        ...
        try:
            ...
            base_token_address = wallet_provider.read_contract(comet_address, COMET_ABI, "baseToken")
