...
def test_borrow_action_success(compound_wallet, compound_provider):
    ...
    # Ensure read_contract returns the base token address
    compound_wallet.read_contract.return_value = "0xBaseToken"
    ...
    with patch("coinbase_agentkit.action_providers.compound.compound_action_provider.format_amount_with_decimals") as mock_format_amount_with_decimals, \
        ...
        compound_wallet.send_transaction.assert_called_once_with({"to": "0xComet", "data": "encoded_borrow_data"})
